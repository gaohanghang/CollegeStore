...
<c:import url="include/nav.jsp"></c:import>
	...
	<div id="nav_detail">
		<h5>
			...
			${goodsCategory1.name } > 
			${goodsCategory2.name } > 
			<a href="${pageContext.request.contextPath }/goods/list.do?id=${goodsCategory3.id }">${goodsCategory3.name }</a> >
		</h5>
	</div>
	<!--产品预览-->
	<div id="shop_detail">
		...
		<div class="right_detail lf">
			...
			<p id="goods_list">
				<s>规格：</s> 
				<c:forEach items="${goodsList }" var="_goods">
				<a class="goods_title 
					<c:if test="${goods.id == _goods.id }">
					selected
					</c:if>
					" 
					href="${pageContext.request.contextPath }/goods/details.do?id=${_goods.id}">
				${_goods.title }
				</a> 
				</c:forEach>
			</p>
			...
			<div class="shops">
				...
				<a href="#" class="collection lf" id="collect"><span>收藏</span></a>
				<b><img src="../images/product_detail/product_detail_img6.png" alt="" /></b>
			</div>
		</div>
	</div>
	<!--为你推荐-->
			...
			<div class="all">
				...
				<div id="sale_protection">
					...
					<div class="sale_content">
						...
						<p class="content">学院商城向您保证所售商品均为正品行货，学院商城自营商品开具机打发票或电子发票。</p>
						...
						<p class="content">
							凭质保证书及学院商城发票，可享受全国联保服务，与您亲临商场选购的商品享受相同的质量保证。学院商城还为您提供具有竞争力的商品价格和运费政策，请您放心购买！
				...
				<div id="packing_list">
					...
					<p class="content">笔记本 x1 适配器 x1 电源线 x1 电池 x1 说明书（电子版）x1
						...
						如果您需要核实此电脑的具体配置型号是否与学院页面相符，可电话咨询学院商城厂商：800-858-2969</p>
				</div>
			</div>
		</div>
		<div class="right rt">
