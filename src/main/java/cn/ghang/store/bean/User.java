...
public class User implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 5658212511683394491L;
	...
	public User(Integer id, String username, String password, String phone, String email, Integer disabled,
	...
	public String toString() {
		return "User [id=" + id + ", username=" + username + ", password=" + password + ", phone=" + phone + ", email="
				+ email + ", disabled=" + disabled + ", createdUser=" + createdUser + ", createdTime=" + createdTime
